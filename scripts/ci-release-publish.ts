 ...
 *
 * Native packages publish generated per-platform leaf packages first, then
 * rewrite the core manifest to contain only the loader/declarations plus pinned
 * optional dependencies for those leaves.
 *
