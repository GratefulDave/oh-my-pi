...
export const SETTINGS_SCHEMA = {
	...
	// Hindsight remote memory, ICM CLI-backed memory, or off. Legacy
	// `memories.enabled` keeps gating the local backend; see
	...
	"skills.enableLibraryUser": { type: "boolean", default: true },

	"skills.enableLibraryProject": { type: "boolean", default: true },
	...
	"dev.autoqaPush.endpoint": {
		type: "string",
		// Remote auto-QA publishing is disabled unless the user explicitly
		// configures an endpoint via `PI_AUTO_QA_PUSH_URL` or
		// `dev.autoqaPush.endpoint`.
		default: undefined,
		ui: {
			tab: "tools",
			label: "Auto QA Push Endpoint",
			description: "Full URL that receives the JSON payload. Remote publishing is disabled unless configured.",
		},
	},
