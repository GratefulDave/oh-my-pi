...
export const FASTEMBED_CACHE_DIR = nodePath.join(os.homedir(), ".hermes", "cache", "fastembed");
export const MODEL_CACHE_DIR = nodePath.join(os.homedir(), ".hermes", "mnemosyne", "models");
...
export function dbPath(env: Env = process.env): string {
	return nodePath.join(dataDir(env), DEFAULT_DB_FILENAME);
}
