...
- Fixed OpenRouter app attribution `HTTP-Referer` to point at the project homepage `https://omp.sh` instead of the outdated GitHub repo URL ([#1102](https://github.com/can1357/oh-my-pi/issues/1102))
